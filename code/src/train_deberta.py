...
"""
DeBERTa-v3-small sentiment classification with WeightedRandomSampler.
...
- Prints accuracy, F1-micro, F1-macro, and classification report
"""
...
OUTPUT_DIR = "../models/deberta_disneyland"
...
def main():
    ...
    model = DebertaV2ForSequenceClassification.from_pretrained(
        MODEL_NAME,
        num_labels=3,  # 3 sentiment classes: 0, 1, 2
    )
    ...
    # Train
    # --------------------------
    print("Starting training with DeBERTa-v3-small + WeightedRandomSampler ...")
    trainer.train()
